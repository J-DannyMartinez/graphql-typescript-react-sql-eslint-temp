...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"node_modules/express/index.js":[function(require,module,exports) {
/*!
 * express
...
},{}],"node_modules/apollo-server-express/dist/index.js":[function(require,module,exports) {
"use strict";
...
},{}],"model/schema/graphql.js":[function(require,module,exports) {
var _templateObject;
...
},{"apollo-server-express":"node_modules/apollo-server-express/dist/index.js"}],"node_modules/parcel-bundler/index.js":[function(require,module,exports) {
...
var _require2 = require("./model/schema/graphql"),
...
var app = express();
var file = "./server.js"; // Pass an absolute path to the entrypoint here

var options = {}; // See options section of api docs, for the possibilities
// Initialize a new bundler using a file and options

var bundler = new Bundler(file, options); // Let express use the bundler middleware, this will let Parcel handle every request over your express server
...
function _startApolloServer() {
  _startApolloServer = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var server;
...
startApolloServer();
console.log("hey");
app.use(bundler.middleware()); //node server.js
},{"express":"node_modules/express/index.js","apollo-server-express":"node_modules/apollo-server-express/dist/index.js","./model/schema/graphql":"model/schema/graphql.js","parcel-bundler":"node_modules/parcel-bundler/index.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "44845" + '/');
